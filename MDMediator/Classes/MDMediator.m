...
NSString * const kMDMediatorParamsKeySwiftTargetModuleName = @"kMDMediatorParamsKeySwiftTargetModuleName";

@interface MDMediator ()

@property (nonatomic, strong) NSMutableDictionary *cachedTarget;

@end

@implementation MDMediator

#pragma mark - public methods
+ (instancetype)sharedInstance {
    static MDMediator *mediator;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        mediator = [[MDMediator alloc] init];
...
- (id)performTarget:(NSString *)targetName
  ...
  shouldCacheTarget:(BOOL)shouldCacheTarget {
    ...
    NSString *swiftModuleName = params[kMDMediatorParamsKeySwiftTargetModuleName];
...
MDMediator* _Nonnull MD(void) {
    return [MDMediator sharedInstance];
};
